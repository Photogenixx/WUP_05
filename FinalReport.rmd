...
colPerc(table1)
```
This data shows us that the percent of people that contracted aids while taking the drug was 3.69%
...
fisher.test(table1)
```
This text (Fisher test shows the odds ratio being 1.5439 which indicates the times you are likely to get aids while taking the drug)
